...
public class TestTowerOfHanoi {
	...
	@Test
	public void testForThreeNumber(){
		...
		expectedMoves.add("Move Disk 3 from B to C");
		expectedMoves.add("Move Disk 1 from A to B");
		expectedMoves.add("Move Disk 3 from C to A");
		expectedMoves.add("Move Disk 2 from C to B");
		expectedMoves.add("Move Disk 3 from A to B");
		Assert.assertEquals(expectedMoves, resultMoves.utilTowerOfHanoi("A", "B", "C", 3));
	}
	@Test
	public void testForTwoNumber(){
		...
		expectedMoves.add("Move Disk 1 from A to B");
		expectedMoves.add("Move Disk 2 from C to B");
		Assert.assertEquals(expectedMoves, resultMoves.utilTowerOfHanoi("A", "B", "C", 2));
	}
