...
var ProductComponent = (function () {
    function ProductComponent(router, productService, cartService, mainComponent) {
        this.router = router;
    ...
    ProductComponent.prototype.addToCart = function (product) {
        var _this = this;
        this.cartService.addProductToCart(product).then(function (res) {
            _this.status = res;
            if (_this.status.toString() === "Failure") {
